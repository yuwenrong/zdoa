			...
			<tr style="background-color:#c1d9f3;height:23">
					...
					<tr style="height:23px;">
						...
						<td style="border-bottom:1px solid #a8cde4" align="right">
							...
							<a href="allDoc.action?currenPage=<s:property value="currenPage-1"/>" style="text-decoration:none;color:#0f4097">上一页</a>
							</s:if>
							<s:if test="currenPage<maxPage">
							<a href="allDoc.action?currenPage=<s:property value="currenPage+1"/>" style="text-decoration:none;color:#0f4097">下一页</a>
							</s:if>
						</td>
					</tr>
					</table>
